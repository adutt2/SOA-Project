s<%-- 
    Document   : All_drivers
    Created on : Nov 6, 2017, 11:42:08 PM
    Author     : dutta
--%>
...
<html>
	...
	java.util.List<webservices.DriverModel> result = port.getDrivers();
    ...
    <h1><a href =" http://192.168.0.29:8080/Final_project/Driver_features.jsp"><--<--Click Here to go back</a></h1>
    </body>
</html>
