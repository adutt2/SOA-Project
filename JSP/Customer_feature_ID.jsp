<%-- 
    Document   : Customer_feature_ID
    Created on : Nov 7, 2017, 1:03:24 AM
    Author     : dutta
--%>
...
<html>
	...
	java.lang.String cid = request.getParameter("Customer_ID");
	// TODO process result here
	java.util.List<webservices.CustmerModels> result = port.getCustomerDetails(cid);
